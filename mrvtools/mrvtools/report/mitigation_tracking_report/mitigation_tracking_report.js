...
frappe.query_reports["Mitigation Tracking Report"] = {
	"filters": [
		{
			"fieldname": "monitoring_year",
			"fieldtype": "Select",
			"label": __("Monitoring Year"),
		...
		},
		{
			...
			"fieldtype": "Select",
			"label": __("Location"),
			"options": [" ","National Level","Province Level","City Level","Municipality","Others"]
		},
		{
			"fieldname": "ndc",
			"fieldtype": "Select",
		...
		{
			"fieldname": "market_mechanism",
			"fieldtype": "Select",
			"label": __("Market Mechanism"),
