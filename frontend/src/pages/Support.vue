    ...
    <div class="counter-area fix area-padding" id="about">
      <div class="container-fluid" data-aos="fade-right" data-aos-delay="100">
        ...
        >
          ...
          <div
            class="col-md-12 col-sm-12 col-xs-12 wow fadeInLeft"
            data-wow-delay="0.3s"
          >
            <div v-for="item in data.message" :key="item.name">
              <div v-if="item.support_main_heading">
                <h3 style="color: #000 !important" class="bulletin_heading">
              ...
              <div v-if="data.message.parent_data.bulletin_content1">
                <div
                  v-for="bulletinItem in item.bulletin_content1"
                  :key="item.name"
                >
                  <li
                    v-if="bulletinItem.content"
              ...
              <div v-if="data.message.parent_data.bulletin_content2">
                <div
                  v-for="bulletinItem in item.bulletin_content2"
                  :key="item.name"
                >
                  <li
                    v-if="bulletinItem.content"
              ...
              <div v-if="data.message.parent_data.bulletin_content3">
                <div
                  v-for="bulletinItem in item.bulletin_content3"
                  :key="item.name"
                >
                  <li
                    v-if="bulletinItem.content"
              ...
              <div v-if="data.message.parent_data.bulletin_content4">
                <div
                  v-for="bulletinItem in item.bulletin_content4"
                  :key="item.name"
                >
                  <li
                    v-if="bulletinItem.content"
