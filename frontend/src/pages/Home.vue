<template>
  ...
  >
    <div class="carousel-inner">
      <div
        v-for="(item, index) in data.message.parent_data.carousel_image"
        :key="index"
        class="carousel-item"
      ...
      >
        <div class="card mx-0 image-overlay cus-card" style="height: 50rem">
          <img
            v-if="item.image"
            :src="item.image"
            class="d-block w-100 h-100 carousel_image"
            alt="..."
          />
        </div>
      </div>
  ...
  <div>
    ...
    <div>
      ...
      >
        <div
          class="container-fluid report-top-ground"
        ...
        >
          ...
          <div class="container-fluid" style="padding-bottom: 25px">
            <div class="parent_pops">
              <a
                class="pop"
                @click="openModal(data.message.parent_data.report_image)"
              >
                <img
                  :src="data.message.parent_data.report_image"
                  id="myImg"
                  class="rep_image"
                />
              ...
              <a
                class="pop"
                @click="openModal(data.message.parent_data.report_image1)"
              >
                <img
                  :src="data.message.parent_data.report_image1"
                  id="myImg"
                  class="rep_image"
                />
                <div class="overlay"></div>
              ...
              <a
                class="pop"
                @click="openModal(data.message.parent_data.report_image2)"
              >
                <img
                  :src="data.message.parent_data.report_image2"
                  id="myImg"
                  class="rep_image"
                />
                <div class="overlay"></div>
  ...
  <div
    id="myModal"
    :class="{ 'full-page-modal': isModalOpen }"
    @click="closeModal"
  >
